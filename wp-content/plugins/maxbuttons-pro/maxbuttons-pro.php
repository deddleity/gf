...
Description: The ultimate CSS3 button generator for WordPress. If you have the free version, you should deactivate it when running the Pro version.
Version: 1.6.1
Author: Max Foundry
...
$updater = new PluginUpdateChecker('http://maxbuttons.com/changelog/maxbuttons-pro/info.json', __FILE__);

define('MAXBUTTONS_PRO_VERSION_KEY', 'maxbuttons_pro_version');
define('MAXBUTTONS_PRO_VERSION_NUM', '1.6.1');
...
function mbpro_admin_menu() {
	...
	$menu_title = __('MaxButtons Pro', 'maxbuttons-pro');
