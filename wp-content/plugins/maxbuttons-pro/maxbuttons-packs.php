...
<div id="maxbuttons">
	<div class="wrap">
		...
		<div class="logo">
			...
			<?php printf(__('makers of %sMaxGalleria%s and %sMaxInbound%s', 'maxbuttons-pro'), '<a href="http://maxgalleria.com/" target="_blank">', '</a>', '<a href="http://maxinbound.com/" target="_blank">', '</a>') ?>
		</div>
		...
		<div class="import">
			...
			<div style="display: inline-block; vertical-align: top; margin-left: 100px;">
				<h3><?php _e('Need More Buttons?', 'maxbuttons-pro') ?></h3>
				<p style="padding-bottom: 5px;"><?php _e('We have an ever-growing collection of button packs for you to choose from.', 'maxbuttons-pro') ?></p>
				<a href="http://maxbuttons.com/shop/category/button-packs/" class="button-primary" style="margin-left: 0px;" target="_blank"><?php _e('View All Button Packs', 'maxbuttons-pro') ?></a>
			</div>
		</div>
