	...
	if ($button_id != '') {
		...
		if (isset($button)) {
			...
			if (mbpro_border_radius_values_are_equal($button->border_radius_top_left, $button->border_radius_top_right, $button->border_radius_bottom_left, $button->border_radius_bottom_right)) {
				$style .= 'border-radius: ' . $button->border_radius_top_left . '; ';
				$style .= '-moz-border-radius: ' . $button->border_radius_top_left . '; ';
				$style .= '-webkit-border-radius: ' . $button->border_radius_top_left . '; ';
			}
			else {
			...
			// PIE
			$style .= '-pie-background: linear-gradient(' . $button->gradient_start_color . ' ' . $gradient_stop . '%, ' . $button->gradient_end_color . '); ';
			$style .= 'position: relative; ' ;
			$style .= 'behavior: url("' . MAXBUTTONS_PRO_PLUGIN_URL . '/pie/PIE.htc"); ';
			$style .= '} ';
			...
			// PIE
			$style .= '-pie-background: linear-gradient(' . $button->gradient_start_color_hover . ' ' . $gradient_stop . '%, ' . $button->gradient_end_color_hover . '); ';
			$style .= 'position: relative; ' ;
			$style .= 'behavior: url("' . MAXBUTTONS_PRO_PLUGIN_URL . '/pie/PIE.htc"); ';
			$style .= '} ';
			...
			$output .= '<a id="maxbutton-' . $button->id . '" href="' . $button_url . '" ' . $button_window . ' ' . $button_nofollow . '>';
